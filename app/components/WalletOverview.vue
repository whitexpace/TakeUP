...
<template>
  <div class="space-y-8 font-geist pb-12">
    <div>
      <h1 class="text-neutral-800 text-xl sm:text-2xl font-bold">{{ title }}</h1>
      ...
      <div class="flex justify-end items-start relative z-10">
        <div class="text-right">
          ...
          <p class="text-[10px] font-bold uppercase tracking-[0.2em] opacity-60 -mt-1">
            {{ readOnlyBadgeLabel || "Digital Wallet" }}
          </p>
        </div>
      </div>
    ...
    <div class="flex items-start gap-3 px-2 py-1">
      ...
      <div class="space-y-0.5">
        <h3 class="text-sm font-bold text-neutral-800/80">{{ protectionTitle }}</h3>
    ...
    <div class="grid grid-cols-1 gap-8" :class="gridClass">
      ...
      >
        <div>
          <h3 class="text-2xl font-bold text-neutral-800 font-geist">{{ activityTitle }}</h3>
          <p class="text-neutral-600 text-base mt-1">{{ activitySubtitle }}</p>
        </div>
        ...
        <div class="space-y-4 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar">
          ...
          >
            <div class="flex items-center gap-4">
              ...
              <div>
                <p class="font-bold text-neutral-800">{{ getTransactionLabel(tx) }}</p>
          ...
          <div class="space-y-4">
            ...
            <div class="grid grid-cols-3 gap-2">
              <button
                ...
                :key="amount"
                class="py-3 rounded-2xl bg-neutral-50 hover:bg-neutral-100 border border-neutral-200 font-bold text-neutral-700 transition-colors"
            ...
            <button
              class="w-full py-4 bg-blue-estate text-white rounded-2xl font-bold hover:bg-blue-estate/90 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
