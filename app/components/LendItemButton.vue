<template>
    <button class="w-max h-[62px] flex bg-white rounded-2xl font-geist font-medium text-[20px] text-noble-black items-center justify-center px-8 gap-3 hover:scale-105 active:scale-95 transition-all hover:bg-pale-cashmere shadow-sm">
