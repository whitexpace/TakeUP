<template>
  <form class="w-full max-w-[760px] min-h-[68px] flex items-center gap-3 px-5 py-[10px] pl-[20px] pr-[12px] border-[0.5px] border-cinnamon-ice rounded-[20px] bg-cream" role="search" @submit.prevent="onSubmit">
    <!-- Search Icon (Visible when query is empty) -->
    <svg v-if="!query" width="24" height="24" viewBox="0 0 19 15" fill="none" xmlns="http://www.w3.org/2000/svg" class="text-noble-black opacity-70 flex-shrink-0">
      <circle cx="7" cy="7" r="6.25" stroke="currentColor" stroke-width="1"/>
      <line x1="13.0401" y1="10.792" x2="17.792" y2="13.9599" stroke="currentColor" stroke-width="1" stroke-linecap="round"/>
    </svg>
