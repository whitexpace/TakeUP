...
<template>
  <div class="space-y-6 font-geist text-noble-black">
    ...
    <div>
      ...
      <p class="text-lg text-noble-black tracking-wide">All your items ranked by booking requests.</p>
    </div>
    ...
    <div v-else class="space-y-3">
      ...
      >
        ...
        <span class="text-xs font-semibold text-burning-orange">{{ formatNumber(item.totalBookingRequests) }}</span>
      </NuxtLink>
    </div>
  </div>
</template>
